<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(detailArray) in orderList.detailArrayList" :key="detailArray.skuId">
          <li>
            <img :src="detailArray.imgUrl" alt="" style="weight:100px;height:100px">
          </li>
          <li>
    ...
    <div class="sub clearFix">
      <a class="subBtn" @click="submitHandler">提交订单</a>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods:{
      ...
      async submitHandler() {
        ...
        const result = await reqSubmitOrder(this.orderList.tradeNo,data)
        if(result.code === 200){
